...
namespace FastMoq.Extensions
{
    ...
    public static class MockerCreationExtensions
    {
        ...
        /// <param name="data">The data.</param>
        /// <returns>T.</returns>
        public static T? CreateInstance<T, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>(this Mocker mocker, Dictionary<Type, object?> data)
            where T : class => mocker.CreateInstanceInternal<T>(
            model => mocker.FindConstructorByType(model.InstanceType,
                true,
                typeof(TParam1),
                typeof(TParam2),
        ...
        /// <returns>T.</returns>
        public static T? CreateInstance<T, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>(this Mocker mocker, Dictionary<Type, object?> data)
            where T : class => mocker.CreateInstanceInternal<T>(
            model => mocker.FindConstructorByType(model.InstanceType,
                true,
                typeof(TParam1),
        ...
        /// <param name="data">The arguments.</param>
        /// <returns>T.</returns>
        public static T? CreateInstance<T, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>(this Mocker mocker, 
            Dictionary<Type, object?> data) where T : class => mocker.CreateInstanceInternal<T>(
            model => mocker.FindConstructorByType(model.InstanceType,
                true,
                typeof(TParam1),
                typeof(TParam2),
